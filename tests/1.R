...
abc(fr, 2, c(1,1), lb=-2.028, ub=2.028, criter=200)
...
abc(fs, 5, rep(10,5), lb=-100, ub=100, criter=200)
...
abc(fw, 1, 50,  lb=-100, ub=100, criter=100)
...
abc(fg, 1, 50, lb=-100, ub=100, criter=100)
...
abc(fra, 2, rep(50,2), lb=-100, ub=100, criter=100)
...
abc(fra10, 10, rep(50,10), lb=-600, ub=600, criter=500)
