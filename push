...
CCOONNFFIIGGUURRAATTIIOONN FFIILLEE
   ...
   SSyynnttaaxx
       ...
       If there is no equal sign on the line, the entire line is taken as _n_a_m_e
       ...
       values, when converting value to the canonical form using _-_-_b_o_o_l type
       specifier; _g_i_t _c_o_n_f_i_g will ensure that the output is "true" or "false".

       String values may be entirely or partially enclosed in double quotes.
       You need to enclose variable values in double quotes if you want to
       preserve leading or trailing whitespace, or if the variable value
       contains comment characters (i.e. it contains _# or _;). Double quote "
   ...
   VVaarriiaabblleess
       ...
       advice.*
           ...
           pushUpdateRejected
               ...
               _p_u_s_h_N_o_n_F_F_C_u_r_r_e_n_t, _p_u_s_h_N_o_n_F_F_D_e_f_a_u_l_t, _p_u_s_h_N_o_n_F_F_M_a_t_c_h_i_n_g,
               _p_u_s_h_A_l_r_e_a_d_y_E_x_i_s_t_s, _p_u_s_h_F_e_t_c_h_F_i_r_s_t, and _p_u_s_h_N_e_e_d_s_F_o_r_c_e
               simultaneously.
           ...
           pushNonFFDefault
               Advice to set _p_u_s_h_._d_e_f_a_u_l_t to _u_p_s_t_r_e_a_m or _c_u_r_r_e_n_t when you ran
               ggiitt--ppuusshh(1) and pushed _m_a_t_c_h_i_n_g _r_e_f_s by default (i.e. you did
               not provide an explicit refspec, and no _p_u_s_h_._d_e_f_a_u_l_t
       ...
       core.fileMode
           ...
           See ggiitt--uuppddaattee--iinnddeexx(1).
       ...
       core.ignoreStat
           ...
           where those are very slow, such as Microsoft Windows. See ggiitt--
       ...
       core.worktree
           ...
           _-_-_w_o_r_k_-_t_r_e_e command line option. The value can be an absolute path
       ...
       core.preloadindex
           ...
           and thus relatively high IO latencies. With this set to _t_r_u_e, Git
       ...
       add.ignore-errors, add.ignoreErrors
           ...
           option of ggiitt--aadddd(1). Older versions of Git accept only
       ...
       color.diff
           ...
           This does not affect ggiitt--ffoorrmmaatt--ppaattcchh(1) nor the _g_i_t_-_d_i_f_f_-_*
       ...
       color.diff.<slot>
           ...
           (context text), meta (metainformation), frag (hunk header), _f_u_n_c
       ...
       color.status.<slot>
           ...
           color the _n_o _b_r_a_n_c_h warning is shown in, defaulting to red). The
       ...
       log.date
           ...
           for log.date is similar to using _g_i_t _l_o_g's --date option. Possible
           values are relative, local, default, iso, rfc, and short; see ggiitt--
       ...
       pack.windowMemory
           The window memory size limit used by ggiitt--ppaacckk--oobbjjeeccttss(1) when no
       ...
       status.submodulesummary
           ...
           _s_u_m_m_a_r_y command, which shows a similar output but does not honor
           these settings.
       ...
       submodule.<name>.path, submodule.<name>.url, submodule.<name>.update
           ...
           submodule. These variables are initially populated by _g_i_t _s_u_b_m_o_d_u_l_e
           _i_n_i_t; edit them to override the URL and other values found in the
       ...
       submodule.<name>.ignore
           ...
           "--ignore-submodules" option. The _g_i_t _s_u_b_m_o_d_u_l_e commands are not
...
Git 1.9.1                         01/13/2015                     GIT-CONFIG(1)
